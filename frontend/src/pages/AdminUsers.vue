...
const toggleBlock = async (/** @type {AdminUser} */ user) => {
      ...
      <table v-else class="user-table">
        ...
        <tr v-for="user in users" :key="user.id">
          ...
          <td>
              <span
                  class="badge"
                  :class="user.isBlocked ? 'badge-blocked' : 'badge-active'"
              >
          ...
          <td>
            <div class="actions">
              <RouterLink :to="`/profile/${user.id}`" class="btn-link">
                View
              </RouterLink>
              <button
...
<!-- казваме на JetBrains „спри да се оплакваш за тези неща“ -->
<style>
