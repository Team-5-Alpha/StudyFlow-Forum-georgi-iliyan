...
const handleCreatePost = async () => {
  ...
  if (!isTitleValid.value || !isContentValid.value) {
    error.value = "Please cover the length requirements.";
    return;
  }
    ...
    <div class="create-post-card">
      ...
      <form v-else @submit.prevent="handleCreatePost">
        ...
        <div class="form-group">
          ...
          />
          <span class="char-count" :class="{ 'valid': isTitleValid }">
        ...
        <div class="form-group">
          ...
          ></textarea>
          <span class="char-count" :class="{ 'valid': isContentValid }">
            {{ formData.content.length }} / 8192
          </span>
        </div>
...
.char-count { position: absolute; right: 10px; top: 38px; font-size: 12px; color: #94a3b8; }
.char-count.valid { color: #1F2839FF; }
